...
2. 添加 Few-shot 示例（必须是2025-2026年的最新案例）
3. 明确输出格式和要求
4. 使用角色设定增强效果
5. 添加约束条件（字数、风格等）
6. **强调时效性：明确要求使用2025-2026年最新数据和案例，避免2024年及之前的过时信息**
...
要求：
- 保持原有结构和核心要求
- 增加具体的示例和约束（示例必须是2025-2026年最新案例）
- 使用更明确的指令格式
- 确保输出是可直接使用的完整提示词
- 主题：${topic}
- **关键要求：在提示词中明确要求AI生成文章时必须使用2025-2026年最新数据和案例，绝对避免使用2024年及之前的过时信息**
